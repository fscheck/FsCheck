...
//let mi = typeof<Properties>.GetMethod("Test7")

qcheckType (typeof<Properties>) |> ignore

let result = Properties.Test4 [1;2;3]

//vcheck Gen.String (fun s -> propl (s.Length <100))
...
//    static member Insert2 (x,xs) = prop_Insert2' (x,xs)
//    static member FunctionTest f a b = 1 + f a b 




//qcheck (getGeneratorFor<bool>) (fun b -> propl( b = true))
