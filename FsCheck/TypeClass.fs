...
let typeClasses = new Dictionary<_,_>()
...
///Pass a class to register instances with the given type class.
...
//let overwriteInstances t = findGenerators t |> Seq.iter (fun (t,mi) -> generators.[t] <- mi)
