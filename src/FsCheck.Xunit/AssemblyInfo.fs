...
[<assembly: AssemblyVersionAttribute("2.10.8")>]
[<assembly: AssemblyFileVersionAttribute("2.10.8")>]
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "2.10.8"
    let [<Literal>] AssemblyFileVersion = "2.10.8"
