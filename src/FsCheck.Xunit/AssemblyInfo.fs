...
[<assembly: AssemblyVersionAttribute("2.10.6")>]
[<assembly: AssemblyFileVersionAttribute("2.10.6")>]
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "2.10.6"
    let [<Literal>] AssemblyFileVersion = "2.10.6"
