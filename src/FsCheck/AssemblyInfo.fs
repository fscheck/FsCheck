...
[<assembly: AssemblyVersionAttribute("2.14.6")>]
[<assembly: AssemblyFileVersionAttribute("2.14.6")>]
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "2.14.6"
    let [<Literal>] AssemblyFileVersion = "2.14.6"
