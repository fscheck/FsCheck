...
[<assembly: AssemblyVersionAttribute("2.10.9")>]
[<assembly: AssemblyFileVersionAttribute("2.10.9")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "2.10.9"
    let [<Literal>] AssemblyFileVersion = "2.10.9"
