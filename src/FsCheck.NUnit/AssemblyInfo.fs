...
[<assembly: AssemblyVersionAttribute("2.10.7")>]
[<assembly: AssemblyFileVersionAttribute("2.10.7")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "2.10.7"
    let [<Literal>] AssemblyFileVersion = "2.10.7"
