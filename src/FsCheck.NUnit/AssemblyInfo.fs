...
[<assembly: AssemblyVersionAttribute("2.10.10")>]
[<assembly: AssemblyFileVersionAttribute("2.10.10")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "2.10.10"
    let [<Literal>] AssemblyFileVersion = "2.10.10"
